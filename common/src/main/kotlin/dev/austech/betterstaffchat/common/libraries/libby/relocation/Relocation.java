...
public class Relocation {
  ...
  public Relocation(String pattern, String relocatedPattern,
    ...
    this.relocatedPattern =
        requireNonNull(relocatedPattern, "relocatedPattern").replace("{}", ".");
    this.includes =
        includes != null
   ...
   */
  public String getRelocatedPattern() { return relocatedPattern; }
   ...
   */
  public Collection<String> getIncludes() { return includes; }
   ...
   */
  public Collection<String> getExcludes() { return excludes; }
  ...
  public static class Builder {
    ...
    public Builder relocatedPattern(String relocatedPattern) {
      this.relocatedPattern =
          requireNonNull(relocatedPattern, "relocatedPattern");
      return this;
    }
