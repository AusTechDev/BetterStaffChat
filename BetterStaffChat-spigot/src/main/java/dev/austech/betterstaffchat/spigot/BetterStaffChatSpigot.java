...
public final class BetterStaffChatSpigot
    extends JavaPlugin implements BetterStaffChatPlugin {
  ...
  private void registerCommands() {
    ...
    ReflectionUtil.registerCmd(new StaffChatCommand(
        "staffchat",
        "The command that lets you send a message to the staffchat.",
        getConfig().getStringList("commands.staffchat.aliases")));
    ReflectionUtil.registerCmd(new MuteStaffChatCommand(
        "mutestaffchat",
        "Allows you to toggle whether you receive staff chat or not.",
        getConfig().getStringList("commands.mutestaffchat.aliases")));
    ReflectionUtil.registerCmd(new ToggleStaffChatCommand(
        "togglestaffchat",
        "Allows you to toggle whether or not all your messages to to staffchat.",
        getConfig().getStringList("commands.togglestaffchat.aliases")));
  }
  ...
  public void logPrefix(String string) {
    Bukkit.getConsoleSender().sendMessage("[BetterStaffChat] " +
                                          TextUtil.colorize(string));
  }

  public void logPrefixDebug(String string) {
    if (getConfig().getBoolean("debug"))
      Bukkit.getConsoleSender().sendMessage("[BetterStaffChat] Debug - " +
                                            TextUtil.colorize(string));
  }
