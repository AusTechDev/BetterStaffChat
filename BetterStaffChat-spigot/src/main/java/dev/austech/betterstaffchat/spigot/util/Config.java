...
public class Config {
    public void load() {
        ...
        try {
            ...
            int currentVersion = YamlConfiguration.loadConfiguration(new InputStreamReader(BetterStaffChatSpigot.getInstance().getClass().getResourceAsStream("/config.yml"))).getInt("config-version");
